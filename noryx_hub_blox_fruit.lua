...
local function AsknoryxAI(cau_hoi)
    local url = "https://noryx-ai--hieudevorg.replit.app/api/chat"
...
Attack.Kill = function(model,Succes)
  ...
  if ToolTip == "Blox Fruit" then _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,10,0) * CFrame.Angles(0,math.rad(90),0), model) else _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,30,0) * CFrame.Angles(0,math.rad(180),0), model)end
  if RandomCFrame then wait(.5)_tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25), model) wait(.5)_tp(model.HumanoidRootPart.CFrame * CFrame.new(25, 30, 0), model) wait(.5)_tp(model.HumanoidRootPart.CFrame * CFrame.new(-25, 30 ,0), model) wait(.5)_tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25), model) wait(.5)_tp(model.HumanoidRootPart.CFrame * CFrame.new(-25, 30, 0))end
  end
end
Attack.Kill2 = function(model,Succes)
  ...
  local Equipped = game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool")
  local ToolTip = Equipped.ToolTip
  if ToolTip == "Blox Fruit" then _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,10,0) * CFrame.Angles(0,math.rad(90),0), model) else _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,30,8) * CFrame.Angles(0,math.rad(180),0), model)end
  if RandomCFrame then wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25), model) wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(25, 30, 0), model) wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(-25, 30 ,0), model) wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25), model) wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(-25, 30, 0))end
  end
end
Attack.KillSea = function(model,Succes)
  ...
  local Equipped = game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool")
  local ToolTip = Equipped.ToolTip
  if ToolTip == "Blox Fruit" then _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,10,0) * CFrame.Angles(0,math.rad(90),0), model) else notween(model.HumanoidRootPart.CFrame * CFrame.new(0,50,8)) wait(.85)notween(model.HumanoidRootPart.CFrame * CFrame.new(0,400,0)) wait(1)end
  end
end
Attack.Sword = function(model,Succes)
  ...
  BringEnemy()
  weaponSc("Sword")
  _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,30,0), model)
  if RandomCFrame then wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25), model) wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(25, 30, 0), model) wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(-25, 30 ,0), model) wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25), model) wait(0.1)_tp(model.HumanoidRootPart.CFrame * CFrame.new(-25, 30, 0))end
  end
end
Attack.Mas = function(model,Succes)
  ...
  BringEnemy()
    if model.Humanoid.Health <= HealthM then
      _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,20,0), model)
...
Attack.Masgun = function(model,Succes)
  ...
  BringEnemy()
    if model.Humanoid.Health <= HealthM then
      _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,35,8), model)
      Useskills("Gun","Z")
      Useskills("Gun","X")
    else
      weaponSc("Melee")
...
BringEnemy = function()
    ...
    local maxMob = math.clamp(tonumber(_G.MobM) or 8, 2, 8)
    ...
    for _, it in ipairs(list) do
        ...
        pcall(function()
            ...
            -- Xếp mob thành cụm ổn định quanh tâm, tránh lộn xộn.
            local slot = count - 1
            local cols = 4
            local spacing = 2.2
            local row = math.floor(slot / cols)
            local col = slot % cols
            local off = Vector3.new((col - 1.5) * spacing, 0, row * spacing)
...
getgenv().TweenSpeedFar  = 270
getgenv().TweenSpeedNear = 270
getgenv().TweenLockToken = nil
getgenv().TweenTargetCFrame = nil

_tp = function(I, lockToken)
    local e = plr.Character
    if not e or not e:FindFirstChild("HumanoidRootPart") or not I then return end

    local HRP = e.HumanoidRootPart

    shouldTween = true

    if lockToken ~= nil and getgenv().TweenLockToken == lockToken then
        return
    end

    if lockToken ~= nil then
        getgenv().TweenLockToken = lockToken
        getgenv().TweenTargetCFrame = I
    else
        getgenv().TweenLockToken = nil
        getgenv().TweenTargetCFrame = nil
    end
    ...
    local speed = dist <= 15
        ...
        or  (getgenv().TweenSpeedFar  or 289)
...
Window = redzlib:MakeWindow({
  Title = "noryx hub - blox fruit",
  SubTitle = "T-danh",
  SaveFolder = "noryx-v1[ beta ]"
})

MinimizeButton = Window:AddMinimizeButton({
    Button = { 
        Image = "", -- logo Noryx được dựng hoàn toàn bằng code bên dưới
        BackgroundTransparency = 0,
        Size = UDim2.new(0, 55, 0, 55),
        BackgroundColor3 = Color3.fromRGB(30, 30, 30),
        BorderMode = Enum.BorderMode.Inset,
        BorderSizePixel = 2,
        BorderColor3 = Color3.fromRGB(220, 40, 40)
    },
    Corner = { 
...
--// NORYX SCRIPT LOGO
--// Dựng bằng Frame/TextLabel: vòng tròn đỏ-trắng + N đỏ + X trắng + viền đen.
do
    ...
    local function getButton()
        if typeof(MinimizeButton) == "Instance" and MinimizeButton:IsA("GuiButton") then
            return MinimizeButton
        end
        if type(MinimizeButton) == "table" then
            for _, v in pairs(MinimizeButton) do
                if typeof(v) == "Instance" and v:IsA("GuiButton") then
                    return v
                end
            end
        end
        ...
        for _, v in ipairs(root:GetDescendants()) do
            if v:IsA("GuiButton") and v.Visible then
                ...
                if n:find("minimize", 1, true) or n:find("min", 1, true) then
                    best = v
                    break
                end
            end
    ...
    if button then
        ...
        local RED = Color3.fromRGB(225, 35, 35)
        local WHITE = Color3.fromRGB(255, 255, 255)

        -- Blox-Fruits-inspired pirate emblem, drawn entirely with Roblox UI primitives.
        local disc = Instance.new("Frame")
        disc.Name = "BloxFruitLogo"
        disc.AnchorPoint = Vector2.new(0.5, 0.5)
        disc.Position = UDim2.fromScale(0.5, 0.5)
        disc.Size = UDim2.fromScale(0.90, 0.90)
        disc.BackgroundColor3 = BLACK
        ...
        local function part(name, size, pos, color, rot, z)
        ...
        skull.Position = UDim2.fromScale(0.5,0.48)
        skull.Size = UDim2.fromScale(0.70,0.58)
        skull.Font = Enum.Font.GothamBlack
        skull.Text = "☠"
        skull.TextScaled = true
        skull.TextColor3 = WHITE
        skull.TextStrokeColor3 = RED
        skull.TextStrokeTransparency = 0
        skull.ZIndex = 58
        skull.Parent = logo

        -- Crossed blades behind the skull.
        local blade1 = part("Blade1", UDim2.fromScale(0.075,0.70), UDim2.fromScale(0.50,0.50), RED, 45, 53)
        local blade2 = part("Blade2", UDim2.fromScale(0.075,0.70), UDim2.fromScale(0.50,0.50), WHITE, -45, 53)
        for _, blade in ipairs({blade1, blade2}) do
            local c = Instance.new("UICorner")
            c.CornerRadius = UDim.new(1,0)
            c.Parent = blade
        end

        -- Small red/white fruit-like center mark.
        local fruit = part("FruitCore", UDim2.fromScale(0.18,0.18), UDim2.fromScale(0.50,0.54), RED, 0, 61)
...
-- Noryx theme: đổi màu cam của các nút/toggle thành đỏ
-- Chỉ đổi các màu cam thường gặp của UI, không đụng màu gameplay.
task.spawn(function()
    local function isOrange(c)
        if not c or typeof(c) ~= "Color3" then return false end
        local r, g, b = c.R, c.G, c.B
        return (r > 0.85 and g > 0.40 and g < 0.78 and b < 0.20)
            or (r > 0.85 and g > 0.25 and g < 0.45 and b < 0.12)
    end
            ...
            pcall(function()
                if obj:IsA("GuiObject") then
                    if isOrange(obj.BackgroundColor3) then
                        obj.BackgroundColor3 = Color3.fromRGB(220, 40, 40)
                    end
                    if isOrange(obj.BorderColor3) then
                        obj.BorderColor3 = Color3.fromRGB(220, 40, 40)
                    end
                end
                if obj:IsA("ImageLabel") or obj:IsA("ImageButton") then
                    if isOrange(obj.ImageColor3) then
                        obj.ImageColor3 = Color3.fromRGB(220, 40, 40)
                    end
                end
                if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
                    if isOrange(obj.TextColor3) then
                        obj.TextColor3 = Color3.fromRGB(220, 40, 40)
                    end
                end
            end)
        end
    ...
    while task.wait(0.75) do
        ...
        pcall(function()
            paint(game:GetService("Players").LocalPlayer:FindFirstChildOfClass("PlayerGui") or game:GetService("Players").LocalPlayer.PlayerGui)
        end)
    end
end)
...
Tabs.Info:AddDiscordInvite({
    ...
    Logo = "rbxassetid://dark",
    Invite = "https://discord.gg/k5fHDCAdR"
})
...
AttackDropdown = Tabs.Main:AddDropdown({
    ...
    Flag = "AttackDropdown",
    Options = {"Normal Attack","Fast Attack","Super Fast Attack","noryx Attack"},
    Default = "Fast Attack",
    Callback = function(Value)
    ...
    Callback = function()
        ...
        local success, err = pcall(function()
            local data = HttpService:JSONEncode({
                ["username"] = "Bug Report From noryx Hub",
                ["embeds"] = {{
...
AIModeDropdown = Tabs.AI:AddDropdown({
    ...
    Default = "noryx Normal",
    Callback = function(Value)
        if Value == " noryx Normal" then
            _G.AIMode = "normal"
        elseif Value == "noryx Plus 1.0" then
            _G.AIMode = "plus1"
        elseif Value == "noryx Plus 1.1" then
            _G.AIMode = "plus1_1"
        elseif Value == "noryx Plus 1.2" then
            _G.AIMode = "plus1_2"
        end
    end
})
...
do
    ...
    if pg:FindFirstChild("noryxAI_ScrollUI") then
        pg:FindFirstChild("noryxAI_ScrollUI"):Destroy()
    end

    local ScreenGui = Instance.new("ScreenGui")
    ScreenGui.Name = "noryxAI_ScrollUI"
    ...
    TitleLabel.Text = "🤖 noryx AI - Phản Hồi"
...
Tabs.AI:AddButton({
    ...
    Callback = function()
        ...
        local frame = pg and pg:FindFirstChild("noryxAI_ScrollUI") and pg.nory AI_ScrollUI:FindFirstChild("AIFrame")
        if frame then frame.Visible = true end

        task.spawn(function()
            local ok, ketQua = pcall(AsknoryxAI, bugContent)
...
Tabs.VS:AddButton({
    ...
    Callback = function()
        ...
        local ToolIconID = "rbxassetid://130125605327958" 
      ...
      pcall(function()
        ...
        elseif debug == true and (CFrame.new(5865.0234375, 1208.3154296875, 871.15185546875).Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 50 then
          ...
          elseif NameBelt == "Black" then
            ...
            _G.Prehis_Find = false
            _G.Prehis_Skills = false                        
          elseif NameBelt == "noryx" or NameBelt == "Blue" then
            return nil
          end
        end
...
AttackAuraToggle = Tabs.Prehistoric:AddToggle({
    Name = "Attack Aura",
    Flag = "AttackAura",
    Description = "Đánh các mục tiêu gần người chơi",
    Default = false,
    Callback = function(Value)
        _G.AttackAura = Value
    end
...
-- Attack Aura mới: cache mục tiêu, giới hạn số hit mỗi nhịp, không tự động chạy khi tắt.
do
    local Players = game:GetService("Players")
    local ReplicatedStorage = game:GetService("ReplicatedStorage")
    local Player = Players.LocalPlayer
    ...
    local function scan(root)
        local enemies = workspace:FindFirstChild("Enemies")
        if not enemies then cache = {}; return end
        local now = os.clock()
        ...
        for _, enemy in ipairs(enemies:GetChildren()) do
            ...
            if hum and hrp and hum.Health > 0 then
                ...
                if d <= RANGE then
                    list[#list + 1] = {model = enemy, hrp = hrp, dist = d}
                end
            end
        end
        table.sort(list, function(a,b) return a.dist < b.dist end)
        ...
        while task.wait(0.03) do
            if _G.AttackAura then
                pcall(function()
                    ...
                    scan(root)
                    local now = os.clock()
                    if now - lastHit < COOLDOWN or #cache == 0 then return end
                    ...
                    for _, item in ipairs(cache) do
                        ...
                        local hrp = item.model:FindFirstChild("HumanoidRootPart")
                        if hum and hrp and hum.Health > 0 and (hrp.Position - root.Position).Magnitude <= RANGE then
                            count += 1
                            args[1] = args[1] or item.model:FindFirstChild("Head") or hrp
                            args[2][count] = {item.model, hrp}
                        end
                    end

                    if count > 0 and args[1] then
...
local function TweenTo(targetCFrame)
    ...
    local speed = 289 -- Tốc độ bay Noryx
